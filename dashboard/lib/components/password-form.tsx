        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 rounded border border-[var(--border-color)] ${inputError
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center items-center py-3 px-4 bg-[var(--highlight)] text-[var(--background)] font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors disabled:opacity-70"
            >
              {isLoading ? (
